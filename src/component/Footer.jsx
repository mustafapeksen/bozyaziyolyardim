        ...
        <footer>
            ...
            <div>
                ...
                <div id="phone-connect">
                    <a className="whatsapp" aria-label="Chat on WhatsApp" href="https://wa.me/+905316187998">
                        <img className="whatsapp" alt="Chat on WhatsApp" src="/image/WhatsAppButtonGreenLarge.svg" />
                    </a>
                    <a className="cellphone" href="tel:+905316187998"><img className="cellphone" src="/image/PhoneCall.png" alt="Phone on Telephone" /></a>
                </div>
            </div>
        </footer>);
}
